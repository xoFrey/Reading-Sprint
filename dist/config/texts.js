...
exports.Texts = {
    panel: {
        title: "📚 Lese-Sprints",
        description: "Willkommen beim Lese-Sprint-Panel! Plane einen Sprint, starte sofort einen, " +
    ...
    schedule: {
        ...
        success: (timestamp, duration) => `✅ Sprint geplant für <t:${timestamp}:F> (Dauer: ${duration}).`,
    ...
    start: {
        ...
        announcement: (duration) => `🏁 Ein neuer Lese-Sprint hat begonnen! Dauer: **${duration}**.`,
    },
    end: {
    ...
    grace: {
        started: (minutes, endTimestamp) => `⏳ Der Sprint ist vorbei! Ihr habt noch **${minutes} Minuten** Zeit, ` +
    ...
    join: {
        ...
        welcome: (bookTitle) => `📖 Du liest gerade **${bookTitle}**. Nutze die Buttons, um deinen Fortschritt zu verwalten.`,
    },
    bookFormat: {
    ...
    bookSelect: {
        ...
        bookOptionDescription: (format, totalLabel) => `${format} · ${totalLabel}`,
    ...
    participant: {
        ...
        switchBookSuccess: (title) => `📖 Neues Buch gestartet: **${title}**.`,
        ...
        updatePageInvalid: "❌ Ungültiger Fortschritt. Er muss zwischen dem Startwert und dem Gesamtumfang liegen.",
    },
    sprintEnd: {
        ...
        levelUp: (level) => `🎉 Level-Up! Jetzt Level **${level}**.`,
    },
    leaderboard: {
        title: "🏆 Leaderboard",
        noData: "Noch keine Daten vorhanden. Sei der/die Erste!",
        entry: (rank, level, currentXP, xpForNext, totalXP) => `**#${rank}** — Level ${level}\n` +
